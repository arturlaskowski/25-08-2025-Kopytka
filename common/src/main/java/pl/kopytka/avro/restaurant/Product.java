...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 4364186490899283238L;


    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"pl.kopytka.avro.restaurant\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"quantity\",\"type\":\"int\"}]}");
     ...
     */
    public static pl.kopytka.avro.restaurant.Product.Builder newBuilder() {
        return new pl.kopytka.avro.restaurant.Product.Builder();
    }
     ...
     * @return A new Product RecordBuilder
     */
    public static pl.kopytka.avro.restaurant.Product.Builder newBuilder(pl.kopytka.avro.restaurant.Product.Builder other) {
        if (other == null) {
            return new pl.kopytka.avro.restaurant.Product.Builder();
        } else {
            return new pl.kopytka.avro.restaurant.Product.Builder(other);
        }
    }
     ...
     * @return A new Product RecordBuilder
     */
    public static pl.kopytka.avro.restaurant.Product.Builder newBuilder(pl.kopytka.avro.restaurant.Product other) {
        if (other == null) {
            return new pl.kopytka.avro.restaurant.Product.Builder();
        } else {
            return new pl.kopytka.avro.restaurant.Product.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(pl.kopytka.avro.restaurant.Product.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(pl.kopytka.avro.restaurant.Product other) {
            super(SCHEMA$, MODEL$);
            if (isValidValue(fields()[0], other.id)) {
                this.id = data().deepCopy(fields()[0].schema(), other.id);
         ...
         * @return This builder.
         */
        public pl.kopytka.avro.restaurant.Product.Builder setId(java.util.UUID value) {
         ...
         * @return This builder.
         */
        public pl.kopytka.avro.restaurant.Product.Builder clearId() {
            id = null;
         ...
         * @return This builder.
         */
        public pl.kopytka.avro.restaurant.Product.Builder setQuantity(int value) {
         ...
         * @return This builder.
         */
        public pl.kopytka.avro.restaurant.Product.Builder clearQuantity() {
