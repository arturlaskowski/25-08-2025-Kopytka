...
public class PaymentEventAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<PaymentEventAvroModel> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<PaymentEventAvroModel> DECODER =
   ...
   */
  public static BinaryMessageEncoder<PaymentEventAvroModel> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PaymentEventAvroModel> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<PaymentEventAvroModel> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this PaymentEventAvroModel to a ByteBuffer.
  ...
  /**
   * Deserializes a PaymentEventAvroModel from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a PaymentEventAvroModel instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static PaymentEventAvroModel fromByteBuffer(
   ...
   */
  public pl.kopytka.avro.payment.PaymentEventType getType() {
    return type;
  }
   ...
   * @param value the value to set.
   */
  public void setType(pl.kopytka.avro.payment.PaymentEventType value) {
    this.type = value;
  }
  ...
  /**
   * Creates a new PaymentEventAvroModel RecordBuilder.
   * @return A new PaymentEventAvroModel RecordBuilder
   */
  public static pl.kopytka.avro.payment.PaymentEventAvroModel.Builder newBuilder() {
    return new pl.kopytka.avro.payment.PaymentEventAvroModel.Builder();
  }

  /**
   * Creates a new PaymentEventAvroModel RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new PaymentEventAvroModel RecordBuilder
   */
  public static pl.kopytka.avro.payment.PaymentEventAvroModel.Builder newBuilder(pl.kopytka.avro.payment.PaymentEventAvroModel.Builder other) {
    if (other == null) {
      return new pl.kopytka.avro.payment.PaymentEventAvroModel.Builder();
    } else {
      return new pl.kopytka.avro.payment.PaymentEventAvroModel.Builder(other);
    }
  }

  /**
   * Creates a new PaymentEventAvroModel RecordBuilder by copying an existing PaymentEventAvroModel instance.
   * @param other The existing instance to copy.
   * @return A new PaymentEventAvroModel RecordBuilder
   */
  public static pl.kopytka.avro.payment.PaymentEventAvroModel.Builder newBuilder(pl.kopytka.avro.payment.PaymentEventAvroModel other) {
    if (other == null) {
      return new pl.kopytka.avro.payment.PaymentEventAvroModel.Builder();
    } else {
      return new pl.kopytka.avro.payment.PaymentEventAvroModel.Builder(other);
  ...
  /**
   * RecordBuilder for PaymentEventAvroModel instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentEventAvroModel>
    ...
    /**
     * Creates a Builder by copying an existing PaymentEventAvroModel instance
     * @param other The existing instance to copy.
     */
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<PaymentEventAvroModel>
    WRITER$ = (org.apache.avro.io.DatumWriter<PaymentEventAvroModel>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<PaymentEventAvroModel>
    READER$ = (org.apache.avro.io.DatumReader<PaymentEventAvroModel>)MODEL$.createDatumReader(SCHEMA$);
