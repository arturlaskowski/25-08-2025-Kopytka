...
CREATE SCHEMA IF NOT EXISTS product_search_schema;
...
CREATE USER product_search_user WITH PASSWORD 'product_search_password';
...
GRANT ALL PRIVILEGES ON SCHEMA product_search_schema TO product_search_user;
...
ALTER ROLE product_search_user SET search_path TO product_search_schema;
